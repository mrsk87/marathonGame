class Level1 extends Phaser.Scene {
  ...
  // }
          ...
          console.log("wave");
          var object = this.physics.add.sprite(800,90, 'wave');
          ...
          addUfo() {
          console.log("Ufo");
          var ufo = this.physics.add.sprite(800,Phaser.Math.Between(120, 500), 'ufo');
          ...
          botaoRestart(){
              ...
              .setInteractive()
              .on('pointerdown', () => this.scene.restart("Level2"));
